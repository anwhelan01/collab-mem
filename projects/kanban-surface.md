...
STATUS: active        UPDATED: 2026-08-03 by overnight documentation sweep
...
- **Current projection:** machine-rendered `docs/board-state.md` at `f3e416d`
  (2026-08-03 02:00 UTC) shows 27 blocked, 2 triage and 3 done cards, with no
