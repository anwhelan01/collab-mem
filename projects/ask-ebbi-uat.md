...
This is the current product and UAT source of truth. Ask Ebbi 2 is retired; the
`ask-ebbi-3` repository is preserved as source/history, not the live UAT lane.

## Where

- **Canonical local repo:** `/Volumes/deep-1t/Users/k3ss/k3ss-official/ask-ebbi-uat/`, branch `main`.
...
1. captured and verified a reversible source archive;
...
- GitHub `main`, local checkout and host marker all resolve to `1c3d257`;
...
- Complete encrypted off-host backup and restore proof for both named volumes.
...
2. **Rae:** preserve repository/host/container provenance after each release.
