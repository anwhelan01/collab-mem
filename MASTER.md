...
| M20 | **Kanban Surface Manager — KISS execution layer over collab-mem** — KSM is the single writer; KRP handles deterministic coordination; ACP starts real Hermes/Codex work only. Card: `projects/kanban-surface.md` | Codex | **active** | `alwyzon-1` is rebuilt and dark; KSM/Hermes/Codex are live and isolated; daemon and real ACP turns passed. Current = finish `KSM-PILOT-1` worker PR, then wire the collab-mem projection without MCP/public ingress. |
