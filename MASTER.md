...
| M18 | **Ask Ebbi 3 — the Planning Oracle** — Hermes-native Ask Ebbi product, Library MCP, 91k appeals. Card: `projects/ask-ebbi-3.md` | Tony / Ask Ebbi Codex | **active** | Healthy on the M4 at :8051 and public `askebbi.com`; next = reconcile the canonical branch and deploy an isolated Compose project to `alwyz-01-dock`. |
